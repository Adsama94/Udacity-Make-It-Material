...
public class ArticleListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoordinatorLayout mCoordinatorLayout = findViewById(R.id.main_activity_layout);
...
//        toolbar.setElevation(4);
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            Snackbar snackbar = Snackbar.make(mCoordinatorLayout, getString(R.string.check_connection), Snackbar.LENGTH_LONG);
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (!publishedDate.before(START_OF_EPOCH.getTime())) {
                holder.subtitleView.setText(Html.fromHtml(DateUtils.getRelativeTimeSpanString(publishedDate.getTime(), System.currentTimeMillis(), DateUtils.HOUR_IN_MILLIS, DateUtils.FORMAT_ABBREV_ALL).toString() + "<br/>" + mCursor.getString(ArticleLoader.Query.AUTHOR)));
            } else {
                holder.subtitleView.setText(Html.fromHtml(outputFormat.format(publishedDate) + "<br/>" + mCursor.getString(ArticleLoader.Query.AUTHOR)));
